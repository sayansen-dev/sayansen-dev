...
I design multi-service automation agents and build full-stack, AI-powered products end to end. Front-end developer by background, now focused on n8n workflow automation, LLM / AI agent orchestration, and shipping real products with AI-assisted development.

---

**What I work with**

- **AI & Automation:** n8n · AI agents (OpenAI / LLMs) · prompt engineering · Claude Code
- **Front-End:** React · React Native (Expo) · TypeScript · JavaScript
- **Back-End & Data:** Node.js · Express · PostgreSQL · Supabase · Redis / BullMQ
- **Cloud & Integrations:** Google Cloud (Cloud Run, Cloud SQL, VPC) · Slack · Zoho CRM · Google Workspace · LinkedIn · X · WordPress · Apify
...
[LinkedIn](https://www.linkedin.com/in/sayansendev/) · sensayan41.ss@gmail.com
